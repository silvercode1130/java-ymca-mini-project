...
public class ItemController {
	...
	public String itemList(@RequestParam(value="searchKeyword", required=false) String searchKeyword, 
										 String category, 
										 Model model, 
										 @RequestParam(value="type_idx", required=false) Integer type_idx,
										 @RequestParam(value="item_for", defaultValue="dog") String item_for) {  // 실행되는 메서드
